function autoplayCarousel() {
  ...
  const slideContainerEl = carouselEl.querySelector("#c2-cont");
  const slideEl = carouselEl.querySelector(".caro2");
  let slideWidth = slideEl.offsetWidth;

  // Add click handlers
  document.querySelector("#back-button2").addEventListener("click", () => navigate("backward"));
  document.querySelector("#forward-button2").addEventListener("click", () => navigate("forward"));
  ...
  document.querySelectorAll(".caro2").forEach((slide) => {
